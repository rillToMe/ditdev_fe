import { FiGithub, FiInstagram, FiHeart, FiMusic } from 'react-icons/fi';
...
const GROUND_OFFSET = 28; // Adjust knight position from bottom (px)
    ...
    <footer className="relative border-t border-pixel-blue/10 overflow-hidden">
      ...
      <div className="relative z-20">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="mt-4 pt-4 border-t border-pixel-blue/10">
        ...
        <div className="relative" style={{ height: '100px', filter: 'drop-shadow(0 0 6px rgba(0,200,255,0.25))' }}>
          <KnightRunner groundY={GROUND_OFFSET} />
        </div>
